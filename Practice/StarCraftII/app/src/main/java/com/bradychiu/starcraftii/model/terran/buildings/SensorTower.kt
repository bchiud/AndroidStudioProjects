...
class SensorTower() : Building() {
    override val nameResourceId = R.string.terran_building_sensor_tower
    override val iconResourceId = R.drawable.terran_building_sensor_tower
